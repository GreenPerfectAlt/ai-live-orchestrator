...
:: ═══════════════════════════════════════════════════════════════
:: ai-live-orchestrator — Gemma-4-E4B QAT launcher (УПРОЩЁННЫЙ)
:: ═══════════════════════════════════════════════════════════════
...
set "LAUNCHER_NAME=run_llama_gemma-4-E4B-it-qat-UD-Q4_K_XL.bat"
...
set "MODEL_PATH=C:\AI\0\Gemma_4\gemma-4-E4B\gemma-4-E4B-it-qat-UD-Q4_K_XL.gguf"
set "MM_PROJ_PATH=C:\AI\0\Gemma_4\gemma-4-E4B\mmproj-F16-gemma-4-E4B-it-qat.gguf"
...
start "llama-server E4B" "%LLAMA_SERVER_EXE%" -m "%MODEL_PATH%" --mmproj "%MM_PROJ_PATH%" --alias "%LLAMA_MODEL%" --host 127.0.0.1 %LLAMA_FLAGS%
timeout /t 5 /nobreak >nul

echo ===================================================
echo  ai-live-orchestrator — Gemma-4-E4B QAT
